 ...
 */
 Ext.define('MyApp.view.basicSettings.target.modify.ModifyController', {
    extend: 'Ext.app.ViewController',
    requires: [
        // 'Ext.window.MessageBox',
        // 'Ext.window.Window'
    ],
    alias: 'controller.basicSettings-target-modify',
    /*
        私有对象：
            _cb_commit //提交按钮回调
            _maskCmp //显示的时候遮罩的组件
    ...
    show: function(targetName) {
        ...
        //设置值
        this.lookupReference('txtName').setValue(targetName);
        var self = this;
        //继承调用show
